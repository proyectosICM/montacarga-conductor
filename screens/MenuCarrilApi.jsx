...
import globalStyles, { LogoAb } from "../Styles/general.jsx";
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.column}>
            {item && (
              <Button
                title={`${item.id} - ${item.estadosModel.nombre} ${item.cantidadMontacargas ? ` - ${item.cantidadMontacargas} Montacargas ` : ""} `}
