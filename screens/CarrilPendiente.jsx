...
export function CarrilPendiente() {
  ...
  return (
    <View style={globalStyles.container}>
      ...
      <Text style={globalStyles.title}>Por favor espere a que los montacargas acepten realizar la carga</Text>
      <Text style={globalStyles.title}>Montacargas que han aceptado: {cantidadM}</Text>
      <Text style={globalStyles.title}>Trabaruedas colocado: {carril && carril.trabaruedas ? "Si" : "No"}</Text>
